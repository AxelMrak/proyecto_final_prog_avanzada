...
formato \texttt{.mov} y \texttt{.mp4}), siete capturas de pantalla
(\texttt{.png}) y un diagrama de arquitectura. Todo el material está
disponible junto al código fuente en el repositorio.
